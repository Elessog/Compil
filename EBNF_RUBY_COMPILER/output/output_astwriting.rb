...
class CLASSDECLARATION < Ast
    attr_accessor :identifier_1,:oidentifier_1,:oidentifier_2,:rvardeclaration_1,:rmethoddeclaration_1
    def initialize identifier_1=nil,oidentifier_1=nil,oidentifier_2=nil,rvardeclaration_1=[],rmethoddeclaration_1=[]
      @identifier_1=identifier_1
      @oidentifier_1=oidentifier_1
      @oidentifier_2=oidentifier_2
